...
class Main extends Component {
	...
	changeUserCharacterWithJSON = () => {
		...
		var json = { id: this.changeuser.ID, password: md5(this.state.resetPassword),nickname:this.changeuser.username};
		loginService.changeuserPasswor(json, response => {
			this.setState({
				changeuserVisible: false,
			});
			this.getUserList();
				...
				>
					...
					>
						<div style={{ height: 100, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
							...
							>
								<text style={{ width: 120, textAlign: 'right', fontSize: 15 }}>密码:</text>
								<div  style={{ width: 200, marginLeft: 30, fontSize: 15 }}>
									<Input 
										size="default" 
										placeholder="请重新设置密码"
